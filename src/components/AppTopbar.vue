...
<template>
    <div
        class="bg-surface-0 dark:bg-surface-900 p-6 rounded-md max-w-7xl mx-auto border border-surface-200 dark:border-surface-700 w-full"
    >
        <div class="flex justify-between items-center">
            <div class="flex gap-3 items-center">
                <span class="hidden sm:flex flex-col">
                    <span class="text-xl text-surface-700 dark:text-surface-100 leading-none font-semibold"
